...
### HTML-Seite, inkl. URL
![alt text](https://github.com/duyminh-nguyen/TBZ_m346_mingu/blob/main/URLWebsite.png)

### Liste der EC2-Instanzen
![alt text](https://github.com/duyminh-nguyen/TBZ_m346_mingu/blob/main/AllInstances.png)

### Details der Web Server-Instanz (öffentliche IP sichtbar)

![alt text](https://github.com/duyminh-nguyen/TBZ_m346_mingu/blob/main/PublicIPAddress.png)

### Security-Group: Liste der Inbound-Regeln
![alt text](https://github.com/duyminh-nguyen/TBZ_m346_mingu/blob/main/InboundRules.png)

## Lab 4.2 - S3

### Liste der Buckets
![alt text](https://github.com/duyminh-nguyen/TBZ_m346_mingu/blob/main/BucketList.png)
### HTML-Seite, inkl. URL
![alt text](https://github.com/duyminh-nguyen/TBZ_m346_mingu/blob/main/WebsiteURLS3.png)
